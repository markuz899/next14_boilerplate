          ...
          <svg className="wave primary" viewBox="0 0 1440 190" version="1.1">
            <defs>
              <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                <stop stop-color={theme.colors.primaryLight} offset="20%" />
                <stop stop-color={theme.colors.primaryDark} offset="100%" />
              </linearGradient>
            </defs>
            <path
          ...
          <svg className="wave warning" viewBox="0 0 1440 190" version="1.1">
            <defs>
              <linearGradient id="sw-gradient-1" x1="0" x2="0" y1="1" y2="0">
                <stop stop-color={theme.colors.warning} offset="0%" />
                <stop stop-color={theme.colors.warningDark} offset="100%" />
              </linearGradient>
            </defs>
            <path
              style={{ transform: "translate(0, 0px)", opacity: 1 }}
